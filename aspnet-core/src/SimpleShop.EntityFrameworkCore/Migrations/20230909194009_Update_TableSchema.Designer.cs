...
namespace SimpleShop.EntityFrameworkCore.Migrations
{
    ...
    [Migration("20230909194009_Update_TableSchema")]
    partial class Update_TableSchema
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SimpleShop.Domain.Functions.Function", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier")
            ...
            modelBuilder.Entity("SimpleShop.Domain.Users.User", b =>
                {
                    b.HasOne("SimpleShop.Domain.Functions.Function", null)
                        .WithMany()
                        .HasForeignKey("Id")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
